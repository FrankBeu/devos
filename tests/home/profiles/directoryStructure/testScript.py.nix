...
with subtest("▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ tests.home.profiles.directoryStructure"):
      ...
      machine.succeed(f"[[ -d /home/{username}/ROUTINES/EXISTENTIAL ]]")
      machine.succeed(f"[[ -d /home/{username}/ROUTINES/MENTAL      ]]")
      machine.succeed(f"[[ -d /home/{username}/ROUTINES/MISC        ]]")
