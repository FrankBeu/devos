{
  ...
  kcs       = ''kubecolor describe                                                 '';

  kcsp      = ''kubecolor describe pod                                             '';
  kcspa     = ''kubecolor describe pod                --all-namespaces             '';

  kcsd      = ''kubecolor describe deployment                                      '';
  kcsda     = ''kubecolor describe deployment         --all-namespaces             '';

  kcss      = ''kubecolor describe service                                         '';
  kcssa     = ''kubecolor describe service            --all-namespaces             '';

  kcsn      = ''kubecolor describe node                                            '';
  kcsna     = ''kubecolor describe node               --all-namespaces             '';

  kcsi      = ''kubecolor describe ingress                                         '';
  kcsia     = ''kubecolor describe ingress            --all-namespaces             '';

  kcsr      = ''kubecolor describe role                                            '';
  kcsra     = ''kubecolor describe role               --all-namespaces             '';

  kcsrb     = ''kubecolor describe rolebinding                                     '';
  kcsrba    = ''kubecolor describe rolebinding        --all-namespaces             '';

  kcscr     = ''kubecolor describe clusterrole                                     '';
  kcscra    = ''kubecolor describe clusterrole        --all-namespaces             '';

  kcscrb    = ''kubecolor describe clusterrolebinding                              '';
  kcscrba   = ''kubecolor describe clusterrolebinding --all-namespaces             '';
