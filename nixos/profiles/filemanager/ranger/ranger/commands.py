...
class shell(Command):
    ...
    def execute(self):
        ...
        if command:
            ### enable on layer alias (note: aliases which call aliases are not working)
            # self.fm.execute_command(command, flags=flags)
            self.fm.execute_command("bash -c '" + command + "'", flags=flags)
            # self.fm.execute_command('echo testtestetstsetsetsetse', flags=flags)
...
class test(Command):
    ...
    def execute(self):
        self.fm.notify('This is a custom command')
