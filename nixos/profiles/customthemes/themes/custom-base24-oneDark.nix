{
  ### https://github.com/Base24/base24-one-dark-scheme
  custom-base24-oneDark = {
    slug   = "oneDark";
    name   = "One Dark";
    author = "Base24";
    colors = {
      base00 = "282c34"; ### "#282c34" Default Background                                                 ##
      base01 = "3f4451"; ### "#3f4451" Lighter Background (Used for status bars)
      base02 = "4f5666"; ### "#4f5666" Selection Background
      base03 = "545862"; ### "#545862" Comments, Invisibles, Line Highlighting
      base04 = "9196a1"; ### "#9196a1" Dark Foreground (Used for status bars)
      ...
      base10 = "21252b"; ### "#21252b" base00 darker
      base11 = "181a1f"; ### "#181a1f" base00 darker
